...
class HiggsAudioModel(HiggsAudioPreTrainedModel, GenerationMixin):
    ...
    def _sample(
        ...
        **model_kwargs,
        ...
        is_cfg_enabled = True # guidance_scale > 1.0
        ...
        while self._has_unfinished_sequences(
            ...
            if init_model_input or not generation_config.use_cache:
                ...
                if is_audio_generation_mode and generation_config.use_cache:
                    if is_cfg_enabled:
                        model_inputs["audio_out_ids"] = model_kwargs["audio_out_ids"][:, -1:].repeat(1, 2)
                        #print("Audio out ids for CFG:", model_inputs["audio_out_ids"])
                        model_inputs["audio_out_ids_start"] = torch.tensor([0, 1], dtype=torch.long, device=input_ids.device)
                    else:
            ...
            if is_cfg_enabled:
                ...
                uncond_audio_logits = outputs.audio_logits[1:]
